...
(function (ns) {
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.ip-target-select-controls{display:none;align-items:center;gap:10px;padding:5px 14px;border-top:1px solid rgba(255,255,255,.06);border-bottom:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.015)}',
            '.ip-target-select-controls button{background:none;border:none;color:var(--theme-accent-color,#00a4dc);font-size:.8rem;cursor:pointer;padding:2px 0;text-decoration:underline;text-underline-offset:2px;opacity:.8;line-height:1.4}',
            '.ip-target-select-controls button:hover{opacity:1}',
            '.ip-target-select-controls .ip-sel-sep{opacity:.25;font-size:.85rem;user-select:none}',
