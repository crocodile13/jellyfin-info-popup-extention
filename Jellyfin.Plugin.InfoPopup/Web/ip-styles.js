...
(function (ns) {
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.ip-user-overlay-back{background:none;border:1px solid rgba(255,255,255,.2);border-radius:4px;color:var(--theme-text-color,#e5e5e5);padding:6px 14px;font-size:.9rem;cursor:pointer;display:flex;align-items:center;gap:6px;transition:background .15s}',
            '.ip-user-overlay-back:hover{background:rgba(255,255,255,.08)}',
