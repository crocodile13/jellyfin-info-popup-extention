...
(function (ns) {
    ...
    var _dicts = {
        fr: {
            ...
            tbl_col_views:       'Lectures',
            views_badge_tip:     '{0} lecteur(s) sur {1} cible(s) — cliquer pour le détail',
            views_modal_title:   'Lectures — {0}',
            views_seen_label:    'Vu par {0} sur {1}',
            views_unseen_label:  'Pas encore vu ({0})',
            views_targets_all:   'Tous les utilisateurs Jellyfin',
            views_empty_seen:    'Personne n’a encore vu ce message.',
            views_empty_unseen:  'Tous les destinataires ont vu ce message.',
            views_loading:       'Chargement…',
            views_err:           'Impossible de charger les accusés de lecture.',
            views_close:         'Fermer',
            search_placeholder:      'Rechercher (titre, auteur)…',
            search_user_placeholder: 'Rechercher un utilisateur…',
            search_count:            '{0} sur {1}',
            maint_title:                   'Maintenance',
            maint_hint:                    'Actions de nettoyage et de réinitialisation. Toutes irréversibles — confirmation demandée.',
            maint_err:                     'Échec : {0}',
            maint_clear_seen_label:        'Vider les accusés de lecture',
            maint_clear_seen_desc:         'Tous les utilisateurs reverront chaque message à leur prochaine connexion.',
            maint_clear_seen_btn:          'Vider',
            maint_clear_seen_confirm:      'Effacer tous les accusés de lecture ?\n\nTous les utilisateurs reverront chaque message à leur prochaine connexion.',
            maint_clear_seen_ok:           '{0} accusé(s) de lecture effacé(s).',
            maint_clear_replies_label:     'Vider toutes les réponses',
            maint_clear_replies_desc:      'Supprime toutes les réponses utilisateurs. Les messages restent intacts.',
            maint_clear_replies_btn:       'Vider',
            maint_clear_replies_confirm:   'Effacer TOUTES les réponses ?\n\nLes messages eux-mêmes sont conservés.',
            maint_clear_replies_ok:        '{0} réponse(s) effacée(s).',
            maint_purge_deleted_label:     'Purger les messages supprimés',
            maint_purge_deleted_desc:      'Supprime définitivement les messages soft-deletés (et leurs réponses).',
            maint_purge_deleted_btn:       'Purger',
            maint_purge_deleted_confirm:   'Purger définitivement les messages supprimés ?\n\nIls disparaîtront du tableau admin et leurs réponses sont effacées en cascade.',
            maint_purge_deleted_ok:        '{0} message(s) purgé(s).',
            maint_reset_settings_label:    'Réinitialiser les paramètres',
            maint_reset_settings_desc:     'Restaure les réglages globaux à leurs valeurs par défaut. Messages, droits et données utilisateurs préservés.',
            maint_reset_settings_btn:      'Réinitialiser',
            maint_reset_settings_confirm:  'Réinitialiser tous les paramètres aux valeurs par défaut ?\n\nN\'affecte ni les messages, ni les droits, ni les données utilisateurs.',
            maint_reset_settings_ok:       'Paramètres réinitialisés.',
            ...
            perm_role_reader:       'Lecteur',
            perm_role_contributor:  'Contributeur',
            perm_role_moderator:    'Mod\u00e9rateur',
            perm_role_admin:        'Administrateur',
            perm_role_custom:       'Personnalis\u00e9',
            perm_bulk_label:        'Appliquer le r\u00f4le :',
            perm_bulk_apply:        'Appliquer',
            perm_bulk_applied:      'Appliqu\u00e9 \u00e0 {0} utilisateur(s)',
            perm_details_show:      'D\u00e9tails',
            perm_sel_all:           'Tout s\u00e9lectionner',
            perm_sel_none:          'Tout d\u00e9s\u00e9lectionner',
            perm_sel_invert:        'Inverser la s\u00e9lection',
            perm_sel_count:         '{0} s\u00e9lectionn\u00e9(s)',
            perm_apply_sel:         'Appliquer \u00e0 la s\u00e9lection',
            perm_bulk_none_selected:'S\u00e9lectionnez au moins un utilisateur.',
            perm_save_all:          'Enregistrer les droits',
            perm_saved_all:         'Droits enregistr\u00e9s \u2713',
            user_page_back:         'Retour',
            ...
            user_msg_edit:           'Modifier',
            user_msg_delete:         'Supprimer',
            user_msg_save:           'Enregistrer',
            user_msg_cancel:         'Annuler',
            user_msg_confirm_delete: 'Supprimer ce message ?',
            user_msg_your_reply:     'Votre r\u00e9ponse',
            user_msg_replies_count_s:'{0} r\u00e9ponse re\u00e7ue',
        ...
        en: {
            ...
            tbl_col_views:       'Views',
            views_badge_tip:     '{0} reader(s) out of {1} target(s) — click for details',
            views_modal_title:   'Views — {0}',
            views_seen_label:    'Seen by {0} of {1}',
            views_unseen_label:  'Not yet seen ({0})',
            views_targets_all:   'All Jellyfin users',
            views_empty_seen:    'No one has seen this message yet.',
            views_empty_unseen:  'All recipients have seen this message.',
            views_loading:       'Loading…',
            views_err:           'Unable to load read receipts.',
            views_close:         'Close',
            search_placeholder:      'Search (title, author)…',
            search_user_placeholder: 'Search a user…',
            search_count:            '{0} of {1}',
            maint_title:                   'Maintenance',
            maint_hint:                    'Data cleanup and reset actions. All irreversible — confirmation required.',
            maint_err:                     'Failed: {0}',
            maint_clear_seen_label:        'Clear read receipts',
            maint_clear_seen_desc:         'All users will see every message again on their next sign-in.',
            maint_clear_seen_btn:          'Clear',
            maint_clear_seen_confirm:      'Clear all read receipts?\n\nAll users will see every message again on their next sign-in.',
            maint_clear_seen_ok:           '{0} read receipt(s) cleared.',
            maint_clear_replies_label:     'Clear all replies',
            maint_clear_replies_desc:      'Deletes every user reply. Messages remain intact.',
            maint_clear_replies_btn:       'Clear',
            maint_clear_replies_confirm:   'Clear ALL replies?\n\nThe messages themselves are preserved.',
            maint_clear_replies_ok:        '{0} reply/replies cleared.',
            maint_purge_deleted_label:     'Purge soft-deleted messages',
            maint_purge_deleted_desc:      'Permanently removes soft-deleted messages (and their replies in cascade).',
            maint_purge_deleted_btn:       'Purge',
            maint_purge_deleted_confirm:   'Permanently purge soft-deleted messages?\n\nThey disappear from the admin table and their replies cascade-delete.',
            maint_purge_deleted_ok:        '{0} message(s) purged.',
            maint_reset_settings_label:    'Reset settings',
            maint_reset_settings_desc:     'Restores global settings to defaults. Messages, permissions and user data are preserved.',
            maint_reset_settings_btn:      'Reset',
            maint_reset_settings_confirm:  'Reset all settings to defaults?\n\nDoes not affect messages, permissions or user data.',
            maint_reset_settings_ok:       'Settings reset.',
            tbl_edit_btn:        '\u270e Edit',
            ...
            perm_role_reader:       'Reader',
            perm_role_contributor:  'Contributor',
            perm_role_moderator:    'Moderator',
            perm_role_admin:        'Administrator',
            perm_role_custom:       'Custom',
            perm_bulk_label:        'Apply role:',
            perm_bulk_apply:        'Apply',
            perm_bulk_applied:      'Applied to {0} user(s)',
            perm_details_show:      'Details',
            perm_sel_all:           'Select all',
            perm_sel_none:          'Deselect all',
            perm_sel_invert:        'Invert selection',
            perm_sel_count:         '{0} selected',
            perm_apply_sel:         'Apply to selection',
            perm_bulk_none_selected:'Select at least one user.',
            perm_save_all:          'Save permissions',
            perm_saved_all:         'Permissions saved ✓',
            user_page_back:         'Back',
            ...
            user_msg_edit:           'Edit',
            user_msg_delete:         'Delete',
            user_msg_save:           'Save',
            user_msg_cancel:         'Cancel',
            user_msg_confirm_delete: 'Delete this message?',
            user_msg_your_reply:     'Your reply',
            user_msg_replies_count_s:'{0} reply received',
        ...
        es: {
            ...
            tbl_col_views:       'Lecturas',
            views_badge_tip:     '{0} lector(es) de {1} destinatario(s) — clic para detalle',
            views_modal_title:   'Lecturas — {0}',
            views_seen_label:    'Visto por {0} de {1}',
            views_unseen_label:  'Aún no visto ({0})',
            views_targets_all:   'Todos los usuarios de Jellyfin',
            views_empty_seen:    'Nadie ha visto este mensaje aún.',
            views_empty_unseen:  'Todos los destinatarios han visto este mensaje.',
            views_loading:       'Cargando…',
            views_err:           'No se pueden cargar los acuses de lectura.',
            views_close:         'Cerrar',
            search_placeholder:      'Buscar (título, autor)…',
            search_user_placeholder: 'Buscar usuario…',
            search_count:            '{0} de {1}',
            maint_title:                   'Mantenimiento',
            maint_hint:                    'Acciones de limpieza y restablecimiento. Todas irreversibles — se solicitará confirmación.',
            maint_err:                     'Error: {0}',
            maint_clear_seen_label:        'Borrar acuses de lectura',
            maint_clear_seen_desc:         'Todos los usuarios verán cada mensaje de nuevo al iniciar sesión.',
            maint_clear_seen_btn:          'Borrar',
            maint_clear_seen_confirm:      '¿Borrar todos los acuses de lectura?\n\nTodos los usuarios verán cada mensaje de nuevo al iniciar sesión.',
            maint_clear_seen_ok:           '{0} acuse(s) de lectura borrado(s).',
            maint_clear_replies_label:     'Borrar todas las respuestas',
            maint_clear_replies_desc:      'Elimina todas las respuestas. Los mensajes permanecen intactos.',
            maint_clear_replies_btn:       'Borrar',
            maint_clear_replies_confirm:   '¿Borrar TODAS las respuestas?\n\nLos mensajes se conservan.',
            maint_clear_replies_ok:        '{0} respuesta(s) borrada(s).',
            maint_purge_deleted_label:     'Purgar mensajes eliminados',
            maint_purge_deleted_desc:      'Elimina permanentemente los mensajes con borrado lógico (y sus respuestas en cascada).',
            maint_purge_deleted_btn:       'Purgar',
            maint_purge_deleted_confirm:   '¿Purgar permanentemente los mensajes eliminados?\n\nDesaparecen del panel admin y sus respuestas se eliminan en cascada.',
            maint_purge_deleted_ok:        '{0} mensaje(s) purgado(s).',
            maint_reset_settings_label:    'Restablecer configuración',
            maint_reset_settings_desc:     'Restaura los ajustes globales a los valores predeterminados. Mensajes, permisos y datos preservados.',
            maint_reset_settings_btn:      'Restablecer',
            maint_reset_settings_confirm:  '¿Restablecer toda la configuración a los valores predeterminados?\n\nNo afecta a los mensajes, permisos ni datos de usuario.',
            maint_reset_settings_ok:       'Configuración restablecida.',
            tbl_edit_btn:        '\u270e Editar',
            ...
            perm_role_reader:       'Lector',
            perm_role_contributor:  'Contribuidor',
            perm_role_moderator:    'Moderador',
            perm_role_admin:        'Administrador',
            perm_role_custom:       'Personalizado',
            perm_bulk_label:        'Aplicar rol:',
            perm_bulk_apply:        'Aplicar',
            perm_bulk_applied:      'Aplicado a {0} usuario(s)',
            perm_details_show:      'Detalles',
            perm_sel_all:           'Seleccionar todo',
            perm_sel_none:          'Deseleccionar todo',
            perm_sel_invert:        'Invertir selección',
            perm_sel_count:         '{0} seleccionado(s)',
            perm_apply_sel:         'Aplicar a la selección',
            perm_bulk_none_selected:'Seleccione al menos un usuario.',
            perm_save_all:          'Guardar permisos',
            perm_saved_all:         'Permisos guardados ✓',
            user_page_back:         'Volver',
            ...
            user_msg_edit:           'Modificar',
            user_msg_delete:         'Eliminar',
            user_msg_save:           'Guardar',
            user_msg_cancel:         'Cancelar',
            user_msg_confirm_delete: '¿Eliminar este mensaje?',
            user_msg_your_reply:     'Tu respuesta',
            user_msg_replies_count_s:'{0} respuesta recibida',
        ...
        de: {
            ...
            tbl_col_views:       'Aufrufe',
            views_badge_tip:     '{0} Leser von {1} Empfänger — klicken für Details',
            views_modal_title:   'Aufrufe — {0}',
            views_seen_label:    'Gelesen von {0} von {1}',
            views_unseen_label:  'Noch nicht gelesen ({0})',
            views_targets_all:   'Alle Jellyfin-Benutzer',
            views_empty_seen:    'Diese Nachricht wurde noch nicht gelesen.',
            views_empty_unseen:  'Alle Empfänger haben diese Nachricht gelesen.',
            views_loading:       'Lädt…',
            views_err:           'Lesebestätigungen konnten nicht geladen werden.',
            views_close:         'Schließen',
            search_placeholder:      'Suchen (Titel, Autor)…',
            search_user_placeholder: 'Benutzer suchen…',
            search_count:            '{0} von {1}',
            maint_title:                   'Wartung',
            maint_hint:                    'Bereinigungs- und Reset-Aktionen. Alle unumkehrbar — Bestätigung erforderlich.',
            maint_err:                     'Fehlgeschlagen: {0}',
            maint_clear_seen_label:        'Lesebestätigungen löschen',
            maint_clear_seen_desc:         'Alle Benutzer sehen jede Nachricht beim nächsten Login erneut.',
            maint_clear_seen_btn:          'Löschen',
            maint_clear_seen_confirm:      'Alle Lesebestätigungen löschen?\n\nAlle Benutzer sehen jede Nachricht beim nächsten Login erneut.',
            maint_clear_seen_ok:           '{0} Lesebestätigung(en) gelöscht.',
            maint_clear_replies_label:     'Alle Antworten löschen',
            maint_clear_replies_desc:      'Löscht alle Antworten. Nachrichten bleiben unverändert.',
            maint_clear_replies_btn:       'Löschen',
            maint_clear_replies_confirm:   'ALLE Antworten löschen?\n\nDie Nachrichten selbst bleiben erhalten.',
            maint_clear_replies_ok:        '{0} Antwort(en) gelöscht.',
            maint_purge_deleted_label:     'Gelöschte Nachrichten endgültig entfernen',
            maint_purge_deleted_desc:      'Entfernt soft-gelöschte Nachrichten endgültig (und deren Antworten kaskadiert).',
            maint_purge_deleted_btn:       'Endgültig entfernen',
            maint_purge_deleted_confirm:   'Gelöschte Nachrichten endgültig entfernen?\n\nSie verschwinden aus der Admin-Tabelle und ihre Antworten werden mitgelöscht.',
            maint_purge_deleted_ok:        '{0} Nachricht(en) entfernt.',
            maint_reset_settings_label:    'Einstellungen zurücksetzen',
            maint_reset_settings_desc:     'Stellt globale Einstellungen auf Standardwerte zurück. Nachrichten, Rechte und Benutzerdaten bleiben erhalten.',
            maint_reset_settings_btn:      'Zurücksetzen',
            maint_reset_settings_confirm:  'Alle Einstellungen auf Standardwerte zurücksetzen?\n\nBeeinflusst weder Nachrichten noch Rechte oder Benutzerdaten.',
            maint_reset_settings_ok:       'Einstellungen zurückgesetzt.',
            ...
            perm_role_reader:       'Leser',
            perm_role_contributor:  'Mitwirkender',
            perm_role_moderator:    'Moderator',
            perm_role_admin:        'Administrator',
            perm_role_custom:       'Benutzerdefiniert',
            perm_bulk_label:        'Rolle anwenden:',
            perm_bulk_apply:        'Anwenden',
            perm_bulk_applied:      'Auf {0} Benutzer angewendet',
            perm_details_show:      'Details',
            perm_sel_all:           'Alle ausw\u00e4hlen',
            perm_sel_none:          'Auswahl aufheben',
            perm_sel_invert:        'Auswahl umkehren',
            perm_sel_count:         '{0} ausgew\u00e4hlt',
            perm_apply_sel:         'Auf Auswahl anwenden',
            perm_bulk_none_selected:'Mindestens einen Benutzer ausw\u00e4hlen.',
            perm_save_all:          'Berechtigungen speichern',
            perm_saved_all:         'Berechtigungen gespeichert \u2713',
            user_page_back:         'Zur\u00fcck',
            ...
            user_msg_system:        'System',
            user_msg_edit:           'Bearbeiten',
            user_msg_delete:         'Löschen',
            user_msg_save:           'Speichern',
            user_msg_cancel:         'Abbrechen',
            user_msg_confirm_delete: 'Diese Nachricht löschen?',
            user_msg_your_reply:     'Deine Antwort',
            user_msg_replies_count_s:'{0} Antwort erhalten',
        ...
        pt: {
            ...
            tbl_col_views:       'Leituras',
            views_badge_tip:     '{0} leitor(es) de {1} destinatário(s) — clique para detalhes',
            views_modal_title:   'Leituras — {0}',
            views_seen_label:    'Visto por {0} de {1}',
            views_unseen_label:  'Ainda não visto ({0})',
            views_targets_all:   'Todos os usuários do Jellyfin',
            views_empty_seen:    'Ninguém viu esta mensagem ainda.',
            views_empty_unseen:  'Todos os destinatários viram esta mensagem.',
            views_loading:       'Carregando…',
            views_err:           'Não foi possível carregar as confirmações de leitura.',
            views_close:         'Fechar',
            search_placeholder:      'Buscar (título, autor)…',
            search_user_placeholder: 'Buscar usuário…',
            search_count:            '{0} de {1}',
            maint_title:                   'Manutenção',
            maint_hint:                    'Ações de limpeza e redefinição. Todas irreversíveis — confirmação solicitada.',
            maint_err:                     'Falha: {0}',
            maint_clear_seen_label:        'Limpar confirmações de leitura',
            maint_clear_seen_desc:         'Todos os usuários verão cada mensagem novamente no próximo login.',
            maint_clear_seen_btn:          'Limpar',
            maint_clear_seen_confirm:      'Limpar todas as confirmações de leitura?\n\nTodos os usuários verão cada mensagem novamente no próximo login.',
            maint_clear_seen_ok:           '{0} confirmação(ões) de leitura apagada(s).',
            maint_clear_replies_label:     'Limpar todas as respostas',
            maint_clear_replies_desc:      'Apaga todas as respostas. As mensagens permanecem intactas.',
            maint_clear_replies_btn:       'Limpar',
            maint_clear_replies_confirm:   'Apagar TODAS as respostas?\n\nAs mensagens em si são preservadas.',
            maint_clear_replies_ok:        '{0} resposta(s) apagada(s).',
            maint_purge_deleted_label:     'Purgar mensagens excluídas',
            maint_purge_deleted_desc:      'Remove definitivamente mensagens soft-deletadas (e suas respostas em cascata).',
            maint_purge_deleted_btn:       'Purgar',
            maint_purge_deleted_confirm:   'Purgar definitivamente mensagens excluídas?\n\nElas desaparecem do painel admin e suas respostas são apagadas em cascata.',
            maint_purge_deleted_ok:        '{0} mensagem(ns) purgada(s).',
            maint_reset_settings_label:    'Redefinir configurações',
            maint_reset_settings_desc:     'Restaura as configurações globais para os padrões. Mensagens, permissões e dados preservados.',
            maint_reset_settings_btn:      'Redefinir',
            maint_reset_settings_confirm:  'Redefinir todas as configurações para os padrões?\n\nNão afeta mensagens, permissões ou dados de usuário.',
            maint_reset_settings_ok:       'Configurações redefinidas.',
            tbl_edit_btn:        '\u270e Editar',
            ...
            perm_hint_0:            '0 = ilimitado',
            perm_role_reader:       'Leitor',
            perm_role_contributor:  'Contribuidor',
            perm_role_moderator:    'Moderador',
            perm_role_admin:        'Administrador',
            perm_role_custom:       'Personalizado',
            perm_bulk_label:        'Aplicar fun\u00e7\u00e3o:',
            perm_bulk_apply:        'Aplicar',
            perm_bulk_applied:      'Aplicado a {0} usu\u00e1rio(s)',
            perm_details_show:      'Detalhes',
            perm_sel_all:           'Selecionar tudo',
            perm_sel_none:          'Desmarcar tudo',
            perm_sel_invert:        'Inverter sele\u00e7\u00e3o',
            perm_sel_count:         '{0} selecionado(s)',
            perm_apply_sel:         'Aplicar \u00e0 sele\u00e7\u00e3o',
            perm_bulk_none_selected:'Selecione pelo menos um utilizador.',
            perm_save_all:          'Guardar permiss\u00f5es',
            perm_saved_all:         'Permiss\u00f5es guardadas \u2713',
            user_page_back:         'Voltar',
            ...
            user_msg_system:        'Sistema',
            user_msg_edit:           'Editar',
            user_msg_delete:         'Excluir',
            user_msg_save:           'Salvar',
            user_msg_cancel:         'Cancelar',
            user_msg_confirm_delete: 'Excluir esta mensagem?',
            user_msg_your_reply:     'Sua resposta',
            user_msg_replies_count_s:'{0} resposta recebida',
        ...
        it: {
            ...
            tbl_col_views:       'Letture',
            views_badge_tip:     '{0} lettore/i su {1} destinatario/i — clicca per dettagli',
            views_modal_title:   'Letture — {0}',
            views_seen_label:    'Visto da {0} di {1}',
            views_unseen_label:  'Non ancora visto ({0})',
            views_targets_all:   'Tutti gli utenti Jellyfin',
            views_empty_seen:    'Nessuno ha ancora visto questo messaggio.',
            views_empty_unseen:  'Tutti i destinatari hanno visto questo messaggio.',
            views_loading:       'Caricamento…',
            views_err:           'Impossibile caricare le conferme di lettura.',
            views_close:         'Chiudi',
            search_placeholder:      'Cerca (titolo, autore)…',
            search_user_placeholder: 'Cerca un utente…',
            search_count:            '{0} di {1}',
            maint_title:                   'Manutenzione',
            maint_hint:                    'Azioni di pulizia e reset. Tutte irreversibili — conferma richiesta.',
            maint_err:                     'Errore: {0}',
            maint_clear_seen_label:        'Cancella conferme di lettura',
            maint_clear_seen_desc:         'Tutti gli utenti vedranno di nuovo ogni messaggio al prossimo accesso.',
            maint_clear_seen_btn:          'Cancella',
            maint_clear_seen_confirm:      'Cancellare tutte le conferme di lettura?\n\nTutti gli utenti vedranno di nuovo ogni messaggio al prossimo accesso.',
            maint_clear_seen_ok:           '{0} conferma/e di lettura cancellata/e.',
            maint_clear_replies_label:     'Cancella tutte le risposte',
            maint_clear_replies_desc:      'Elimina tutte le risposte. I messaggi rimangono intatti.',
            maint_clear_replies_btn:       'Cancella',
            maint_clear_replies_confirm:   'Cancellare TUTTE le risposte?\n\nI messaggi vengono conservati.',
            maint_clear_replies_ok:        '{0} risposta/e cancellata/e.',
            maint_purge_deleted_label:     'Eliminare i messaggi cancellati',
            maint_purge_deleted_desc:      'Elimina definitivamente i messaggi soft-deleted (e le loro risposte a cascata).',
            maint_purge_deleted_btn:       'Elimina',
            maint_purge_deleted_confirm:   'Eliminare definitivamente i messaggi cancellati?\n\nSpariscono dalla tabella admin e le loro risposte vengono cancellate a cascata.',
            maint_purge_deleted_ok:        '{0} messaggio/i eliminato/i.',
            maint_reset_settings_label:    'Ripristina impostazioni',
            maint_reset_settings_desc:     'Ripristina le impostazioni globali ai valori predefiniti. Messaggi, diritti e dati preservati.',
            maint_reset_settings_btn:      'Ripristina',
            maint_reset_settings_confirm:  'Ripristinare tutte le impostazioni ai valori predefiniti?\n\nNon influisce su messaggi, diritti o dati utente.',
            maint_reset_settings_ok:       'Impostazioni ripristinate.',
            ...
            perm_role_reader:       'Lettore',
            perm_role_contributor:  'Contributore',
            perm_role_moderator:    'Moderatore',
            perm_role_admin:        'Amministratore',
            perm_role_custom:       'Personalizzato',
            perm_bulk_label:        'Applica ruolo:',
            perm_bulk_apply:        'Applica',
            perm_bulk_applied:      'Applicato a {0} utente/i',
            perm_details_show:      'Dettagli',
            perm_sel_all:           'Seleziona tutto',
            perm_sel_none:          'Deseleziona tutto',
            perm_sel_invert:        'Inverti selezione',
            perm_sel_count:         '{0} selezionato/i',
            perm_apply_sel:         'Applica alla selezione',
            perm_bulk_none_selected:'Seleziona almeno un utente.',
            perm_save_all:          'Salva permessi',
            perm_saved_all:         'Permessi salvati ✓',
            user_page_back:         'Indietro',
            ...
            user_msg_system:        'Sistema',
            user_msg_edit:           'Modifica',
            user_msg_delete:         'Elimina',
            user_msg_save:           'Salva',
            user_msg_cancel:         'Annulla',
            user_msg_confirm_delete: 'Eliminare questo messaggio?',
            user_msg_your_reply:     'La tua risposta',
            user_msg_replies_count_s:'{0} risposta ricevuta',
        ...
        ja: {
            ...
            tbl_col_date:        '公開日',
            tbl_col_views:       '閲覧',
            views_badge_tip:     '受信者{1}人中{0}人が閲覧 — クリックで詳細',
            views_modal_title:   '閲覧状況 — {0}',
            views_seen_label:    '{1}人中{0}人が閲覧',
            views_unseen_label:  '未読 ({0})',
            views_targets_all:   'Jellyfinの全ユーザー',
            views_empty_seen:    'このメッセージはまだ誰も閲覧していません。',
            views_empty_unseen:  '全ての受信者がこのメッセージを閲覧しました。',
            views_loading:       '読み込み中…',
            views_err:           '既読確認を読み込めません。',
            views_close:         '閉じる',
            search_placeholder:      '検索 (タイトル、送信者)…',
            search_user_placeholder: 'ユーザーを検索…',
            search_count:            '{1}件中{0}件',
            maint_title:                   'メンテナンス',
            maint_hint:                    'データクリーンアップとリセット操作。すべて取り消し不可 — 確認が必要です。',
            maint_err:                     '失敗: {0}',
            maint_clear_seen_label:        '既読履歴をクリア',
            maint_clear_seen_desc:         '全ユーザーが次回ログイン時に全メッセージを再表示します。',
            maint_clear_seen_btn:          'クリア',
            maint_clear_seen_confirm:      'すべての既読履歴をクリアしますか？\n\n全ユーザーが次回ログイン時に全メッセージを再表示します。',
            maint_clear_seen_ok:           '{0}件の既読履歴をクリアしました。',
            maint_clear_replies_label:     'すべての返信をクリア',
            maint_clear_replies_desc:      'すべてのユーザー返信を削除します。メッセージはそのまま残ります。',
            maint_clear_replies_btn:       'クリア',
            maint_clear_replies_confirm:   'すべての返信をクリアしますか？\n\nメッセージ自体は保持されます。',
            maint_clear_replies_ok:        '{0}件の返信をクリアしました。',
            maint_purge_deleted_label:     '削除済みメッセージを完全削除',
            maint_purge_deleted_desc:      'ソフト削除されたメッセージを完全に削除します（返信も連鎖削除）。',
            maint_purge_deleted_btn:       '完全削除',
            maint_purge_deleted_confirm:   '削除済みメッセージを完全に削除しますか？\n\n管理者テーブルから消え、返信も連鎖削除されます。',
            maint_purge_deleted_ok:        '{0}件のメッセージを完全削除しました。',
            maint_reset_settings_label:    '設定をリセット',
            maint_reset_settings_desc:     'グローバル設定をデフォルト値に戻します。メッセージ、権限、ユーザーデータは保持されます。',
            maint_reset_settings_btn:      'リセット',
            maint_reset_settings_confirm:  'すべての設定をデフォルト値にリセットしますか？\n\nメッセージ、権限、ユーザーデータには影響しません。',
            maint_reset_settings_ok:       '設定をリセットしました。',
            tbl_edit_btn:        '\u270e 編集',
            ...
            perm_hint_0:            '0 = \u7121\u5236\u9650',
            perm_role_reader:       '\u8aad\u307f\u53d6\u308a\u5c02\u7528',
            perm_role_contributor:  '\u6295\u7a3f\u8005',
            perm_role_moderator:    '\u30e2\u30c7\u30ec\u30fc\u30bf\u30fc',
            perm_role_admin:        '\u7ba1\u7406\u8005',
            perm_role_custom:       '\u30ab\u30b9\u30bf\u30e0',
            perm_bulk_label:        '\u30ed\u30fc\u30eb\u3092\u9069\u7528\uff1a',
            perm_bulk_apply:        '\u9069\u7528',
            perm_bulk_applied:      '{0}\u4eba\u306e\u30e6\u30fc\u30b6\u30fc\u306b\u9069\u7528\u3057\u307e\u3057\u305f',
            perm_details_show:      '\u8a73\u7d30',
            perm_sel_all:           '\u3059\u3079\u3066\u9078\u629e',
            perm_sel_none:          '\u9078\u629e\u3092\u89e3\u9664',
            perm_sel_invert:        '\u9078\u629e\u3092\u53cd\u8ee2',
            perm_sel_count:         '{0} \u4ef6\u9078\u629e\u4e2d',
            perm_apply_sel:         '\u9078\u629e\u306b\u9069\u7528',
            perm_bulk_none_selected:'\u30e6\u30fc\u30b6\u30fc\u30921\u4eba\u4ee5\u4e0a\u9078\u629e\u3057\u3066\u304f\u3060\u3055\u3044\u3002',
            perm_save_all:          '\u6a29\u9650\u3092\u4fdd\u5b58',
            perm_saved_all:         '\u6a29\u9650\u3092\u4fdd\u5b58\u3057\u307e\u3057\u305f \u2713',
            user_page_back:         '\u623b\u308b',
            ...
            user_msg_delete:         '\u524a\u9664',
            user_msg_save:           '\u4fdd\u5b58',
            user_msg_cancel:         '\u30ad\u30e3\u30f3\u30bb\u30eb',
            user_msg_confirm_delete: '\u3053\u306e\u30e1\u30c3\u30bb\u30fc\u30b8\u3092\u524a\u9664\u3057\u307e\u3059\u304b\uff1f',
            user_msg_your_reply:     '\u3042\u306a\u305f\u306e\u8fd4\u4fe1',
            user_msg_replies_count_s:'{0}\u4ef6\u306e\u8fd4\u4fe1\u3092\u53d7\u4fe1',
        ...
        zh: {
            ...
            tbl_col_date:        '发布时间',
            tbl_col_views:       '已读',
            views_badge_tip:     '{1}个收件人中{0}人已读 — 点击查看详情',
            views_modal_title:   '阅读情况 — {0}',
            views_seen_label:    '{1}人中{0}人已读',
            views_unseen_label:  '未读 ({0})',
            views_targets_all:   '所有Jellyfin用户',
            views_empty_seen:    '尚无人阅读此消息。',
            views_empty_unseen:  '所有收件人都已阅读此消息。',
            views_loading:       '加载中…',
            views_err:           '无法加载已读回执。',
            views_close:         '关闭',
            search_placeholder:      '搜索 (标题、作者)…',
            search_user_placeholder: '搜索用户…',
            search_count:            '{1}个中{0}个',
            maint_title:                   '维护',
            maint_hint:                    '数据清理和重置操作。所有操作不可撤销 — 需要确认。',
            maint_err:                     '失败：{0}',
            maint_clear_seen_label:        '清除已读记录',
            maint_clear_seen_desc:         '所有用户下次登录时将重新看到所有消息。',
            maint_clear_seen_btn:          '清除',
            maint_clear_seen_confirm:      '清除所有已读记录？\n\n所有用户下次登录时将重新看到所有消息。',
            maint_clear_seen_ok:           '已清除{0}条已读记录。',
            maint_clear_replies_label:     '清除所有回复',
            maint_clear_replies_desc:      '删除所有用户回复。消息保持完整。',
            maint_clear_replies_btn:       '清除',
            maint_clear_replies_confirm:   '清除所有回复？\n\n消息本身将被保留。',
            maint_clear_replies_ok:        '已清除{0}条回复。',
            maint_purge_deleted_label:     '清除已删除消息',
            maint_purge_deleted_desc:      '永久删除软删除的消息（及其回复将级联删除）。',
            maint_purge_deleted_btn:       '清除',
            maint_purge_deleted_confirm:   '永久清除已删除消息？\n\n它们将从管理表中消失，其回复将级联删除。',
            maint_purge_deleted_ok:        '已清除{0}条消息。',
            maint_reset_settings_label:    '重置设置',
            maint_reset_settings_desc:     '将全局设置恢复为默认值。消息、权限和用户数据将被保留。',
            maint_reset_settings_btn:      '重置',
            maint_reset_settings_confirm:  '将所有设置重置为默认值？\n\n不影响消息、权限或用户数据。',
            maint_reset_settings_ok:       '设置已重置。',
            tbl_edit_btn:        '\u270e 编辑',
            ...
            perm_hint_0:            '0 = \u4e0d\u9650\u5236',
            perm_role_reader:       '\u8bfb\u8005',
            perm_role_contributor:  '\u8d21\u732e\u8005',
            perm_role_moderator:    '\u7248\u4e3b',
            perm_role_admin:        '\u7ba1\u7406\u5458',
            perm_role_custom:       '\u81ea\u5b9a\u4e49',
            perm_bulk_label:        '\u5e94\u7528\u89d2\u8272\uff1a',
            perm_bulk_apply:        '\u5e94\u7528',
            perm_bulk_applied:      '\u5df2\u5e94\u7528\u5230 {0} \u4e2a\u7528\u6237',
            perm_details_show:      '\u8be6\u60c5',
            perm_sel_all:           '\u5168\u9009',
            perm_sel_none:          '\u53d6\u6d88\u5168\u9009',
            perm_sel_invert:        '\u53cd\u9009',
            perm_sel_count:         '\u5df2\u9009 {0} \u4e2a',
            perm_apply_sel:         '\u5e94\u7528\u5230\u6240\u9009',
            perm_bulk_none_selected:'\u8bf7\u81f3\u5c11\u9009\u62e9\u4e00\u4e2a\u7528\u6237\u3002',
            perm_save_all:          '\u4fdd\u5b58\u6743\u9650',
            perm_saved_all:         '\u6743\u9650\u5df2\u4fdd\u5b58 \u2713',
            user_page_back:         '\u8fd4\u56de',
            ...
            user_msg_save:           '\u4fdd\u5b58',
            user_msg_cancel:         '\u53d6\u6d88',
            user_msg_confirm_delete: '\u5220\u9664\u6b64\u6d88\u606f\uff1f',
            user_msg_your_reply:     '\u60a8\u7684\u56de\u590d',
            user_msg_replies_count_s:'\u6536\u5230 {0} \u6761\u56de\u590d',
